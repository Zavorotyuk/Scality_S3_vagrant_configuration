...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: "yum install make -y"
  config.vm.provision "shell", inline: "sudo dnf install git -y"
  config.vm.provision "shell", inline: "sudo npm install -g npm"
  config.vm.provision "shell", inline: "sudo git clone https://github.com/scality/S3"


  # config.vm.provision :ansible do |ansible|
  #   ansible.playbook = "do_something.yml"
  # end
end
